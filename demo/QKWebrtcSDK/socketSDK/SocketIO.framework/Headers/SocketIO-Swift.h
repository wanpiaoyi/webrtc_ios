...
/// Creates a new <code>SocketAckEmitter</code>.
/// \param socket The socket for this emitter.
///
/// \param ackNum The ack number for this emitter.
///
...
@property (nonatomic, readonly, copy) void (^ _Nullable anyHandler)(SocketAnyEvent * _Nonnull);
...
/// \param toNamespace The namespace that was connected to.
///
- (void)didConnectToNamespace:(NSString * _Nonnull)namespace_;
...
/// Call when you wish to tell the server that you’ve received the event for <code>ack</code>.
/// <em>You shouldn’t need to call this directly.</em> Instead use an <code>SocketAckEmitter</code> that comes in an event callback.
/// \param ack The ack number.
///
/// \param with The data for this ack.
///
